...
Screenshot:
![Devant Dashboard](../screenshots/v2.0/v2_step_01_devant_dashboard.png)
...
Screenshot:
![Integration Editor Loading](../screenshots/v2.0/v2_step_03_editor_loading.png)
...
Screenshot:
![Dashboard Banner Closed](../screenshots/v2.0/v2_step_02_dashboard_banner_closed.png)
...
Screenshot:
![Entry Points Selected](../screenshots/v2.0/v2_step_04_entry_points_selected.png)
...
Screenshot:
![Add Entry Point Attempt](../screenshots/v2.0/v2_step_05_add_entry_point_attempt.png)
...
- Devant Dashboard: ../screenshots/v2.0/v2_step_01_devant_dashboard.png
- Dashboard Banner Closed: ../screenshots/v2.0/v2_step_02_dashboard_banner_closed.png
- Editor Loading: ../screenshots/v2.0/v2_step_03_editor_loading.png
- Entry Points Selected: ../screenshots/v2.0/v2_step_04_entry_points_selected.png
- Add Entry Point Attempt: ../screenshots/v2.0/v2_step_05_add_entry_point_attempt.png
- Editor Refreshed: ../screenshots/v2.0/v2_step_06_editor_refreshed.png
- Editor Reopened: ../screenshots/v2.0/v2_step_07_editor_reopened.png
